  ...
  if (!rec) {
    return (
      <div className="bg-surface rounded-xl border border-border p-5">
        <h3 className="font-medium text-foreground mb-1">Treino de hoje</h3>
        <p className="text-sm text-muted-foreground mb-3">Nenhuma recomendação gerada ainda.</p>
        <Link
  ...
  return (
    <div className="bg-surface rounded-xl border border-border p-5">
      <div className="flex items-center justify-between mb-3">
        <h3 className="font-medium text-foreground">Treino de hoje</h3>
      ...
      {rec.rationale && (
        <p className="text-xs text-muted-foreground mt-3 line-clamp-2">{rec.rationale}</p>
      )}
