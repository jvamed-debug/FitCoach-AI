...
const TSB_BADGE: Record<string, { label: string; className: string }> = {
  ...
  unknown:  { label: "Sem dados",className: "bg-surface-2 text-muted-foreground" },
};
      ...
      <div className="bg-surface border-b border-border px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">{total} atleta{total !== 1 ? "s" : ""} cadastrado{total !== 1 ? "s" : ""}</p>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-muted-foreground mb-4">Nenhum atleta encontrado.</p>
              ...
              <table className="w-full text-sm">
                <thead className="bg-background border-b border-border">
                  <tr>
                    ...
                    <th className="text-center px-4 py-3 font-medium text-muted-foreground">Forma (TSB)</th>
                    <th className="text-center px-4 py-3 font-medium text-muted-foreground">CTL</th>
                    <th className="text-center px-4 py-3 font-medium text-muted-foreground">ATL</th>
                    <th className="text-center px-4 py-3 font-medium text-muted-foreground">Último treino</th>
                      ...
                      <tr key={a.id} className="hover:bg-background transition-colors">
                        ...
                        <td className="px-4 py-3 text-center">
                          {a.days_since_last_workout !== null ? (
                            <span className={a.no_workout_alert ? "text-orange-600 font-medium" : "text-muted-foreground"}>
